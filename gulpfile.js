...
gulp.task('rename', function ()  {
    var newname;
    var author = 'Michael Müller @ marvin + konsorten';
    var email  = 'dev@konsorten.de';
    ...
    if (!newname) {
        console.log('Please write the new timeular name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/timeular.png')) {
        fs.renameSync(__dirname + '/admin/timeular.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/timeular.html')) {
        fs.renameSync(__dirname + '/widgets/timeular.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/timeular/js/timeular.js')) {
        fs.renameSync(__dirname + '/widgets/timeular/js/timeular.js', __dirname + '/widgets/timeular/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/timeular')) {
        fs.renameSync(__dirname + '/widgets/timeular',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /timeular/g,
        ...
        {
            match: /Timeular/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Timeular'
        },
        {
            match: /Michael Müller @ marvin + konsorten/g,
            replacement: author
        },
        {
            match: /dev@konsorten.de/g,
            replacement: email
        }
    ];
    var files = [
